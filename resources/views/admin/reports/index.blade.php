...
<div class="space-y-6">
    ...
    <div class="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm">
        <form action="{{ route('admin.reports.index') }}" method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end text-xs">
            <div>
            ...
            <div class="flex items-center space-x-2">
                <button type="submit" class="flex-1 py-2.5 px-4 rounded-xl bg-slate-800 text-white font-bold hover:bg-slate-900 transition-colors">
                    <i class="fa-solid fa-filter mr-1"></i> Filter
                </button>
                <a href="{{ request()->fullUrlWithQuery(['export' => 'csv']) }}" class="py-2.5 px-4 rounded-xl bg-emerald-600 text-white font-bold hover:bg-emerald-700 transition-colors flex items-center space-x-1" title="Unduh File CSV / Excel">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div class="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm">
            ...
            <h3 class="text-2xl font-extrabold text-slate-900 mt-1">{{ $totalTrips }} Dinas</h3>
        ...
        <div class="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm">
            ...
            <h3 class="text-2xl font-extrabold text-kalbe-600 mt-1">Rp {{ number_format($totalFuelCost, 0, ',', '.') }}</h3>
        ...
        <div class="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm">
            ...
            <h3 class="text-2xl font-extrabold text-slate-900 mt-1">{{ $totalPassengers }} Karyawan</h3>
    ...
    <div class="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-4">
        <h3 class="font-extrabold text-base text-slate-900 pb-3 border-b border-slate-100">Rekapitulasi Data Perjalanan Dinas</h3>
